...
data Tree t = Leaf t | Internal t (Tree t) (Tree t) deriving (Eq, Show)
-- bubbledown :: (Tree a) -> [Tree a]
bubbledown (Leaf a) = [a]
bubbledown (Internal a l r)
  | a > l && a > r && l < r = (l : (bubbledown a)) ++ (bubbledown r)
  | a > l && a > r && r < l = (r : (bubbledown l)) ++ (bubbledown a)
  | a > l && a < r          = (l : (bubbledown a)) ++ (bubbledown r)
  | a > r && a < l          = (r : (bubbledown l)) ++ (bubbledown a)
  | otherwise               = (a : (bubbledown l)) ++ (bubbledown r)
